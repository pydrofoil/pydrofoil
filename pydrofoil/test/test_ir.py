...
i8 = block3.emit(Operation, '@add_i_i_must_fit', [i4, MachineIntConstant(7)], MachineInt(), '`43 269:39-269:44', 'zz43049')
i9 = block3.emit(Cast, '$cast', [i2], GenericBitVector(), '`43 269:30-269:51', 'zz43044')
i10 = block3.emit(Operation, '@vector_subrange_o_i_i', [i9, i8, i4], GenericBitVector(), '`43 269:30-269:51', 'zz43022')
i11 = block3.emit(Operation, '@add_i_i_wrapped_res', [i4, MachineIntConstant(7)], Int(), '`14490', 'zz43040')
i12 = block3.emit(Operation, '@sub_o_i_wrapped_res', [i11, i4], Int(), '`14503', 'zz43034')
i13 = block3.emit(Operation, 'zz5izDzKz5i64', [i12], MachineInt(), None, None)
i14 = block3.emit(Operation, '@add_i_i_wrapped_res', [i13, MachineIntConstant(1)], Int(), '`14510', 'zz43029')
i15 = block3.emit(Operation, 'zzzeros_implicit', [i14], GenericBitVector(), '`43 269:55-269:62', 'zz43023')
i16 = block3.emit(Operation, 'zeq_bits', [i10, i15], Bool(), '`43 269:30-269:62', 'zz43021')
block3.next = ConditionalGoto(i16, block4, block6, '`43 269:27-271:36')
block4.next = Goto(block5, None)
i17 = block5.emit_phi([block6, block4], [SmallBitVectorConstant(255, SmallFixedBitVector(8)), SmallBitVectorConstant(0, SmallFixedBitVector(8))], SmallFixedBitVector(8))
i18 = block5.emit(Cast, '$cast', [i17], GenericBitVector(), None, None)
i19 = block5.emit(Cast, '$cast', [i3], GenericBitVector(), '`43 269:4-269:24', 'zz43017')
i20 = block5.emit(Operation, '@vector_update_subrange_o_i_i_o', [i19, i7, i4, i18], GenericBitVector(), '`43 269:4-269:24', 'zz43020')
i21 = block5.emit(Cast, '$cast', [i20], SmallFixedBitVector(64), '`43 269:4-269:24', 'zz43007')
i3.prevvalues[1] = i21
i22 = block5.emit(Operation, '@iadd', [i4, MachineIntConstant(8)], MachineInt(), '`43 268:2-271:36', 'zz43013')
i4.prevvalues[1] = i22
