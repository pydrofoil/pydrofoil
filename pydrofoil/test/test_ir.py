...
i9 = block1.emit(Operation, '@shiftl_o_i', [i7, i8], GenericBitVector(), '`2 337:4-337:35', 'return')
block1.next = Goto(block2, None)
i10 = block2.emit_phi([block7, block1], [None, i9], GenericBitVector())
block2.next = Return(i10, None)
...
i13 = block4.emit(Operation, '@length_unwrapped_res', [i11], MachineInt(), '`2 141:39-141:48', 'zz41')
i14 = block4.emit(Operation, 'zz5i64zDzKz5i', [i13], Int(), '`2 141:39-141:48', None)
i15 = block4.emit(Operation, 'zlteq_int', [zn, i14], Bool(), '`2 141:32-141:48', 'zz40')
block4.next = ConditionalGoto(i15, block5, block8, '`2 141:29-141:100')
i16 = block5.emit(Operation, 'zz5izDzKz5i64', [zn], MachineInt(), None, None)
i17 = block5.emit(Operation, '@sail_truncate_o_i', [i11, i16], GenericBitVector(), '`2 141:54-141:70', 'return')
block5.next = Goto(block6, None)
i18 = block6.emit_phi([block8, block5], [None, i17], GenericBitVector())
block6.next = Goto(block7, None)
i19 = block7.emit(Operation, 'zz5izDzKz5i64', [zl], MachineInt(), None, None)
i20 = block7.emit(Operation, '@shiftl_o_i', [i18, i19], GenericBitVector(), '`2 340:28-340:50', 'zz44')
i21 = block7.emit(Operation, 'zsub_bits', [i20, i18], GenericBitVector(), '`2 340:19-340:56', 'zz43')
i22 = block7.emit(Operation, 'zz5izDzKz5i64', [zi], MachineInt(), None, None)
i23 = block7.emit(Operation, '@shiftl_o_i', [i21, i22], GenericBitVector(), '`2 340:4-340:60', 'return')
i10.prevvalues[0] = i23
block7.next = Goto(block2, None)
i24 = block8.emit(Operation, 'zz5izDzKz5i64', [zn], MachineInt(), None, None)
i25 = block8.emit(Operation, '@zero_extend_o_i', [i11, i24], GenericBitVector(), '`2 141:76-141:100', 'return')
