...
@pytest.mark.skip("No longer desired behaviour")
...
def test_graph_hangs():
    ...
    ztuplez3z5vecz8z5bvz9_z5vecz8z5boolz9 = Struct(
        "ztuplez3z5vecz8z5bvz9_z5vecz8z5boolz9",
        (
            "ztuplez3z5vecz8z5bvz9_z5vecz8z5boolz90",
            "ztuplez3z5vecz8z5bvz9_z5vecz8z5boolz91",
        ),
        (Vec(GenericBitVector()), Vec(Bool())),
        True,
    )
    zRetired = Enum("zRetired", ("zRETIRE_SUCCESS", "zRETIRE_FAIL"))
    zAccessTypezIuzK = Union(
        "zAccessTypezIuzK",
        ("zExecutezIuzK", "zReadzIuzK", "zReadWritezIuzK", "zWritezIuzK"),
        (
            Unit(),
            Unit(),
            Struct(
                "ztuplez3z5unit_z5unit",
                ("ztuplez3z5unit_z5unit0", "ztuplez3z5unit_z5unit1"),
                (Unit(), Unit()),
                True,
            ),
            Unit(),
    ...
    zTR_ResultzIUExceptionTypezIzKzCbzK = Union(
        "zTR_ResultzIUExceptionTypezIzKzCbzK",
        (
            "zTR_AddresszIUExceptionTypezIzKzCbzK",
            "zTR_FailurezIUExceptionTypezIzKzCbzK",
        ),
        (
            Struct(
                "ztuplez3z5bv_z5unit",
                ("ztuplez3z5bv_z5unit0", "ztuplez3z5bv_z5unit1"),
                (GenericBitVector(), Unit()),
                True,
            ),
            Struct(
                "ztuplez3z5unionz0zzExceptionType_z5unit",
                (
                    "ztuplez3z5unionz0zzExceptionType_z5unit0",
                    "ztuplez3z5unionz0zzExceptionType_z5unit1",
                ),
                (
                    Union(
                        "zExceptionType",
    ...
    zMemoryOpResultzIz8bzCuz9zK = Union(
        "zMemoryOpResultzIz8bzCuz9zK",
        ("zMemExceptionzIz8bzCuz9zK", "zMemValuezIz8bzCuz9zK"),
        (
            Union(
                "zExceptionType",
                (
    ...
    zMemoryOpResultzIbzK = Union(
        "zMemoryOpResultzIbzK",
        ("zMemExceptionzIbzK", "zMemValuezIbzK"),
        (
            Union(
                "zExceptionType",
                (
    ...
    zoptionzIbzK = Union(
        "zoptionzIbzK",
        ("zNonezIbzK", "zSomezIbzK"),
        (Unit(), GenericBitVector()),
    )
    zoptionzIuzK = Union(
        "zoptionzIuzK", ("zNonezIuzK", "zSomezIuzK"), (Unit(), Unit())
    )
    zsync_exception = Struct(
        "zsync_exception",
        ("zexcinfo", "zext", "ztrap"),
        (
            Union(
    ...
    zctl_result = Union(
        "zctl_result",
        ("zCTL_MRET", "zCTL_SRET", "zCTL_TRAP", "zCTL_URET"),
        (
            Unit(),
            Unit(),
            Struct(
    ...
    i7 = block0.emit(
        ...
        [
            znum_elem,
            IntConstant(1),
            IntConstant(1180591620717411303360L),
            StringConstant(
                "Argument 'znum_elem' of function 'zprocess_vlseg'"
            ),
        ],
        Unit(),
        None,
    ...
    i8 = block0.emit(
        ...
        [
            zEMUL_pow,
            StringConstant(
                "Argument 'zEMUL_pow' of function 'zprocess_vlseg'"
            ),
            IntConstant(-6),
            IntConstant(-5),
            IntConstant(-4),
    ...
    i9 = block0.emit(
        ...
        [
            zload_width_bytes,
            StringConstant(
                "Argument 'zload_width_bytes' of function 'zprocess_vlseg'"
            ),
            IntConstant(1),
            IntConstant(2),
            IntConstant(4),
    ...
    i10 = block0.emit(
        ...
        [
            znf,
            StringConstant("Argument 'znf' of function 'zprocess_vlseg'"),
            IntConstant(1),
            IntConstant(2),
            IntConstant(3),
            IntConstant(4),
    ...
    i14 = block2.emit(
        Operation,
        "zread_vmask",
        [znum_elem, zvm, SmallBitVectorConstant(0b0, SmallFixedBitVector(5))],
        Vec(Bool()),
        "`57 74:34-74:67",
        "zz42",
    )
    i15 = block2.emit(
        ...
        [zload_width_bytes, MachineIntConstant(3)],
        MachineInt(),
        "`57 75:71-75:91",
        "zz4141",
    )
    i16 = block2.emit(
        Operation, "zz5i64zDzKz5i", [i15], Int(), "`57 75:47-75:110", "zz4137"
    )
    i17 = block2.emit(
        Operation, "zz5i64zDzKz5i", [znf], Int(), "`57 75:47-75:110", "zz4138"
    )
    i18 = block2.emit(
        Operation,
        "zread_vreg_seg",
        [znum_elem, i16, zEMUL_pow, i17, zvd],
        Vec(GenericBitVector()),
        "`57 75:47-75:110",
        "zz43",
    )
    i19 = block2.emit(
    ...
    i20 = block2.emit(
        Operation,
        "@shl_int_i_i_must_fit",
        [i19, MachineIntConstant(3)],
        MachineInt(),
        "`57 77:52-77:77",
        "zz4132",
    )
    i21 = block2.emit(
        Operation, "zz5i64zDzKz5i", [i20], Int(), "`57 77:23-77:104", "zz4128"
    )
    i22 = block2.emit(
        Operation,
        "zinit_masked_result",
        [znum_elem, i21, zEMUL_pow, i18, i14],
        ztuplez3z5vecz8z5bvz9_z5vecz8z5boolz9,
        "`57 77:23-77:104",
        "zz44",
    )
    ...
    i25 = block2.emit(
        Operation,
        "@sub_o_i_wrapped_res",
        [znum_elem, MachineIntConstant(1)],
        Int(),
        "`57 79:24-79:36",
        "zz4125",
    )
    ...
    i27 = block3.emit_phi(
        [block2, block9], [MachineIntConstant(0), None], MachineInt()
    )
    i28 = block3.emit(
        Operation, "@gt", [i27, i26], Bool(), "`57 79:2-106:3", None
    )
    ...
    block4.next = Goto(block5, None)
    i30 = block5.emit_phi(
        [block22, block20, block24, block4],
        [
            EnumConstant(
                "zRETIRE_FAIL",
    ...
    i33 = block7.emit(
        Operation,
        "@get_slice_int_i_i_i",
        [MachineIntConstant(16), i27, MachineIntConstant(0)],
        SmallFixedBitVector(16),
        "`5 119:26-119:48",
        "return",
    )
    i34 = block7.emit(
        GlobalWrite, "zvstart", [i33], SmallFixedBitVector(16), None, None
    )
    i35 = block7.emit(
        Operation,
        "@sub_i_i_must_fit",
        [znf, MachineIntConstant(1)],
        MachineInt(),
        "`57 82:28-82:34",
        "zz469",
    )
    block7.next = Goto(block8, None)
    i36 = block8.emit_phi(
        [block7, block21], [MachineIntConstant(0), None], MachineInt()
    )
    i37 = block8.emit(
        Operation, "@gt", [i36, i35], Bool(), "`57 82:6-99:7", None
    )
    block8.next = ConditionalGoto(i37, block9, block10, "`57 82:6-99:7")
    i38 = block9.emit(
        Operation,
        "@iadd",
        [i27, MachineIntConstant(1)],
        MachineInt(),
        "`57 79:2-106:3",
        "zz413",
    )
    ...
    i39 = block10.emit(
        Operation, "zz5i64zDzKz5i", [i27], Int(), "`57 83:27-83:33", "zz464"
    )
    i40 = block10.emit(
        Operation,
    ...
    i44 = block10.emit(
        ...
        [MachineIntConstant(64), i42, MachineIntConstant(0)],
        SmallFixedBitVector(64),
        "`5 119:26-119:48",
        "return",
    )
    i45 = block10.emit(
        Comment, "inlined zext_data_get_addr", [], Unit(), None, None
    )
    i46 = block10.emit(Comment, "inlined zrX_bits", [], Unit(), None, None)
    i47 = block10.emit(
        Operation,
        "@unsigned_bv",
        [zrs1, MachineIntConstant(5)],
        MachineInt(),
        "`17 145:45-145:56",
        "zz42",
    )
    ...
    i49 = block10.emit(
        Operation,
        "@add_bits_bv_bv",
        [i48, i44, MachineIntConstant(64)],
        SmallFixedBitVector(64),
        "`24 59:13-59:29",
        "zz44",
    )
    i50 = block10.emit(
        Comment, "inlined zcheck_misaligned", [], Unit(), None, None
    )
    i51 = block10.emit(
        Operation,
        "zplat_enable_misaligned_access",
        [UnitConstant.UNIT],
        Bool(),
        "`39 321:6-321:37",
        "zz43",
    ...
    block12.next = Return(
        DefaultValue(Enum("zRetired", ("zRETIRE_SUCCESS", "zRETIRE_FAIL"))),
        None,
    )
    i56 = block13.emit(
        UnionVariantCheck,
    ...
    i60 = block16.emit(
        ...
        [
            ...
            StringConstant(
                "Access to field 'ztuplez3z5bv_z5unit0' of struct 'ztuplez3z5bv_z5unit'"
            ),
        ],
        Unit(),
        None,
    ...
    i65 = block16.emit(
        GlobalRead, "zcur_privilege", [], zPrivilege, None, None
    )
    i66 = block16.emit(
        Operation,
        "zeffectivePrivilege",
    ...
    i67 = block16.emit(
        Comment, "inlined zmem_read_priv", [], Unit(), None, None
    )
    i68 = block16.emit(
        Operation,
        "zmem_read_priv_meta",
    ...
    i70 = block17.emit(
        Operation,
        "zMemoryOpResult_drop_metazIbzK",
        [i68],
        zMemoryOpResultzIbzK,
        "`32 163:2-163:91",
        "return",
    ...
    i73 = block20.emit(
        UnionCast, "zMemExceptionzIbzK", [i70], zExceptionType, None, None
    )
    i74 = block20.emit(
        Comment, "inlined zhandle_mem_exception", [], Unit(), None, None
    )
    i75 = block20.emit(
        Cast, "$cast", [i49], GenericBitVector(), "`30 479:46-479:56", "zz45"
    )
    i76 = block20.emit(
        Operation,
        "zSomezIbzK",
    ...
    i79 = block20.emit(
        Operation, "zCTL_TRAP", [i78], zctl_result, "`30 481:47-481:58", "zz42"
    )
    i80 = block20.emit(
        GlobalRead, "zcur_privilege", [], zPrivilege, None, None
    )
    i81 = block20.emit(
        GlobalRead, "zPC", [], SmallFixedBitVector(64), None, None
    )
    i82 = block20.emit(
        Operation,
        "zexception_handler",
    ...
    i84 = block20.emit(
        GlobalWrite, "znextPC", [i82], SmallFixedBitVector(64), None, None
    )
    block20.next = Goto(block5, None)
    i85 = block21.emit(
        UnionCast, "zMemValuezIbzK", [i70], GenericBitVector(), None, None
    )
    i86 = block21.emit(
        Operation,
        "@shl_int_i_i_must_fit",
    ...
    i89 = block21.emit(
        Operation,
        "@get_slice_int_i_o_i_unwrapped_res",
        [MachineIntConstant(5), i87, MachineIntConstant(0)],
        SmallFixedBitVector(5),
        "`5 119:26-119:48",
        "return",
    )
    i90 = block21.emit(
    ...
    i100 = block22.emit(
        Operation, "zCTL_TRAP", [i99], zctl_result, "`30 481:47-481:58", "zz42"
    )
    i101 = block22.emit(
        GlobalRead, "zcur_privilege", [], zPrivilege, None, None
    )
    ...
    i104 = block22.emit(
        Comment, "inlined zset_next_pc", [], Unit(), None, None
    )
    i105 = block22.emit(
        GlobalWrite, "znextPC", [i103], SmallFixedBitVector(64), None, None
    )
    ...
    i119 = block24.emit(
        GlobalWrite, "znextPC", [i117], SmallFixedBitVector(64), None, None
    )
    ...
    i121 = block26.emit_phi(
        [block25, block27], [MachineIntConstant(0), None], MachineInt()
    )
    i122 = block26.emit(
        Operation, "@gt", [i121, i120], Bool(), "`57 101:6-104:7", None
    )
    block26.next = ConditionalGoto(i122, block9, block27, "`57 101:6-104:7")
    i123 = block27.emit(
        Operation, "zz5i64zDzKz5i", [i27], Int(), "`57 102:28-102:37", "zz4116"
    )
    i124 = block27.emit(
        Operation,
        "@vector_access_o_i",
    ...
    i130 = block27.emit(
        Operation,
        "@vector_subrange_o_i_i",
        [i127, i129, MachineIntConstant(0)],
        GenericBitVector(),
        "`57 102:27-102:101",
        "zz480",
    )
    ...
    i133 = block27.emit(
        Operation,
        "@get_slice_int_i_o_i_unwrapped_res",
        [MachineIntConstant(5), i131, MachineIntConstant(0)],
        SmallFixedBitVector(5),
        "`5 119:26-119:48",
        "return",
    )
    ...
    i137 = block28.emit(
        Operation, "zz5izDzKz5i64", [zEMUL_pow], MachineInt(), None, None
    )
    i138 = block28.emit(
        Operation, "@pow2_i", [i137], Int(), "`57 72:52-72:66", "zz40"
    )
    i12.prevvalues[0] = i138
    block28.next = Goto(block2, None)
    graph = Graph(
        "zprocess_vlseg",
        [znf, zvm, zvd, zload_width_bytes, zrs1, zEMUL_pow, znum_elem],
        block0,
        True,
    )
    split_for_arg_constness(graph, fakecodegen)
    assert (
        len(list(graph.iterblocks())) < 100
    )  # should not explode the number of graphs
