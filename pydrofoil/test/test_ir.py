...
i10 = block3.emit(Operation, 'zz5izDzKz5i64', [i9], MachineInt(), '`43 269:39-269:44', 'zz43043')
i11 = block3.emit(Cast, '$cast', [i2], GenericBitVector(), '`43 269:30-269:51', 'zz43044')
i12 = block3.emit(Operation, '@vector_subrange_o_i_i', [i11, i10, i4], GenericBitVector(), '`43 269:30-269:51', 'zz43022')
i13 = block3.emit(Operation, '@add_i_i_wrapped_res', [i4, MachineIntConstant(7)], Int(), '`14490', 'zz43040')
i14 = block3.emit(Operation, '@sub_o_i_wrapped_res', [i13, i4], Int(), '`14503', 'zz43034')
i15 = block3.emit(Operation, 'zz5izDzKz5i64', [i14], MachineInt(), None, None)
i16 = block3.emit(Operation, '@add_i_i_wrapped_res', [i15, MachineIntConstant(1)], Int(), '`14510', 'zz43029')
i17 = block3.emit(Operation, 'zzzeros_implicit', [i16], GenericBitVector(), '`43 269:55-269:62', 'zz43023')
i18 = block3.emit(Operation, 'zeq_bits', [i12, i17], Bool(), '`43 269:30-269:62', 'zz43021')
block3.next = ConditionalGoto(i18, block4, block6, '`43 269:27-271:36')
block4.next = Goto(block5, None)
i19 = block5.emit_phi([block6, block4], [SmallBitVectorConstant(255, SmallFixedBitVector(8)), SmallBitVectorConstant(0, SmallFixedBitVector(8))], SmallFixedBitVector(8))
i20 = block5.emit(Cast, '$cast', [i19], GenericBitVector(), None, None)
i21 = block5.emit(Cast, '$cast', [i3], GenericBitVector(), '`43 269:4-269:24', 'zz43017')
i22 = block5.emit(Operation, '@vector_update_subrange_o_i_i_o', [i21, i8, i4, i20], GenericBitVector(), '`43 269:4-269:24', 'zz43020')
i23 = block5.emit(Cast, '$cast', [i22], SmallFixedBitVector(64), '`43 269:4-269:24', 'zz43007')
i3.prevvalues[1] = i23
i24 = block5.emit(Operation, '@iadd', [i4, MachineIntConstant(8)], MachineInt(), '`43 268:2-271:36', 'zz43013')
i4.prevvalues[1] = i24
...
i2 = block0.emit(Operation, '$zupdate_fbits', [SmallBitVectorConstant('0b0', SmallFixedBitVector(1)), MachineIntConstant(0), i1], SmallFixedBitVector(1), '`7 154392:51-154392:65', 'zz4635')
i3 = block0.emit(Operation, '@bitvector_concat_bv_bv', [i2, MachineIntConstant(1), SmallBitVectorConstant('0b1', SmallFixedBitVector(1))], SmallFixedBitVector(2), '`7 154392:41-154392:79', 'zz4627')
i4 = block0.emit(Operation, '@replicate_bv_i_i', [i3, MachineIntConstant(2), MachineIntConstant(32)], SmallFixedBitVector(64), '`7 154392:31-154392:84', 'zz4622')
block0.next = Return(i4, None)
graph = Graph('repl', [arg], block0)
''')
