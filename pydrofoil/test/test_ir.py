...
def test_remove_double_exception():
    ...
    i8 = block6.emit(Operation, 'zsail_assert', [i6], Unit(), '`7 1262:4-1263:17', 'zz45')
...
i3 = block2.emit(Operation, 'zsail_assert', [i2], Unit(), '`7 1262:4-1263:17', 'zz45')
...
i4 = block2.emit(Operation, '@eq_int_o_i', [i1, MachineIntConstant(32)], Bool(), '`7 1262:11-1262:22', 'zz46')
...
i6 = block4.emit(Operation, 'zsail_assert', [i5], Unit(), '`7 1262:4-1263:17', 'zz45')
i7 = block4.emit(Operation, 'zz5izDzKz5i64', [i1], MachineInt(), '`7 1263:4-1263:17', 'zz43')
block4.next = Return(i7, None)
i8 = block5.emit(Operation, '@eq_int_o_i', [i1, MachineIntConstant(36)], Bool(), '`7 1262:25-1262:36', 'zz48')
block5.next = ConditionalGoto(i8, block6, block8, '`7 1262:25-1262:106')
block6.next = Goto(block7, None)
i9 = block7.emit_phi([block10, block6], [None, BooleanConstant.TRUE], Bool())
i5.prevvalues[0] = i9
block7.next = Goto(block4, None)
i10 = block8.emit(Operation, '@eq_int_o_i', [i1, MachineIntConstant(40)], Bool(), '`7 1262:39-1262:50', 'zz410')
block8.next = ConditionalGoto(i10, block9, block11, '`7 1262:39-1262:106')
block9.next = Goto(block10, None)
i11 = block10.emit_phi([block13, block9], [None, BooleanConstant.TRUE], Bool())
i9.prevvalues[0] = i11
block10.next = Goto(block7, None)
i12 = block11.emit(Cast, '$cast', [arg], SmallFixedBitVector(64), None, None)
i13 = block11.emit(Operation, '@eq_int_o_i', [i1, MachineIntConstant(42)], Bool(), '`7 1262:53-1262:64', 'zz412')
block11.next = ConditionalGoto(i13, block12, block14, '`7 1262:53-1262:106')
block12.next = Goto(block13, None)
i14 = block13.emit_phi([block16, block12], [None, BooleanConstant.TRUE], Bool())
i11.prevvalues[0] = i14
i15 = block13.emit(Cast, '$cast', [arg], SmallFixedBitVector(64), None, None)
block13.next = Goto(block10, None)
i16 = block14.emit(Operation, '@eq_int_o_i', [i1, MachineIntConstant(44)], Bool(), '`7 1262:67-1262:78', 'zz414')
block14.next = ConditionalGoto(i16, block15, block17, '`7 1262:67-1262:106')
block15.next = Goto(block16, None)
i17 = block16.emit_phi([block17, block15], [None, BooleanConstant.TRUE], Bool())
i14.prevvalues[0] = i17
block16.next = Goto(block13, None)
i18 = block17.emit(Operation, '@eq_int_o_i', [i1, MachineIntConstant(48)], Bool(), '`7 1262:81-1262:92', 'zz416')
i17.prevvalues[0] = i18
block17.next = Goto(block16, None)
graph = Graph('zAArch64_PAMax', [arg], block0)'''
...
i17 = block10.emit(Operation, '@add_bits_bv_bv', [zaddr, zwidth, MachineIntConstant(64)], SmallFixedBitVector(64), '`14 132:50-132:62', 'zz413')
i18 = block10.emit(Operation, '@unsigned_bv_wrapped_res', [i17, MachineIntConstant(64)], Int(), '`1 231:32-231:43', 'zz40')
i19 = block10.emit(Operation, 'lteq', [i18, i4], Bool(), '`1 231:32-231:58', 'return')
block10.next = Goto(block11, None)
i20 = block11.emit_phi([block15, block10], [BooleanConstant.FALSE, i19], Bool())
block11.next = ConditionalGoto(i20, block12, block14, '`14 132:29-134:48')
i21 = block12.emit(GlobalRead, 'zPMP_Match', [], Int(), None, None)
block12.next = Goto(block13, None)
i22 = block13.emit_phi([block14, block12], [None, i21], Int())
i14.prevvalues[0] = i22
block13.next = Goto(block8, None)
i23 = block14.emit(GlobalRead, 'zPMP_PartialMatch', [], Int(), None, None)
i22.prevvalues[0] = i23
block14.next = Goto(block13, None)
block15.next = Goto(block11, None)
i24 = block16.emit(Operation, '@unsigned_bv_wrapped_res', [zaddr, MachineIntConstant(64)], Int(), '`1 231:47-231:58', 'zz41')
i25 = block16.emit(Operation, 'lteq', [i4, i24], Bool(), '`1 231:32-231:58', 'return')
