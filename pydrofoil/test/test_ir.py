...
i7 = block3.emit(Operation, '@add_i_i_wrapped_res', [i4, MachineIntConstant(7)], Int(), '`43 269:12-269:17', 'zz43052')
i8 = block3.emit(Operation, 'zz5izDzKz5i64', [i7], MachineInt(), '`43 269:12-269:17', 'zz43015')
i9 = block3.emit(Operation, '@add_i_i_wrapped_res', [i4, MachineIntConstant(7)], Int(), '`43 269:39-269:44', 'zz43049')
i10 = block3.emit(Cast, '$cast', [i2], GenericBitVector(), '`43 269:30-269:51', 'zz43044')
i11 = block3.emit(Operation, 'zz5i64zDzKz5i', [i4], Int(), '`43 269:30-269:51', 'zz43046')
i12 = block3.emit(Operation, 'zsubrange_bits', [i10, i9, i11], GenericBitVector(), '`43 269:30-269:51', 'zz43022')
i13 = block3.emit(Operation, 'zz5i64zDzKz5i', [i4], Int(), '`14481', 'zz43041')
i14 = block3.emit(Operation, 'z__id', [i13], Int(), '`14483', 'zz43042')
i15 = block3.emit(Operation, '@add_o_i_wrapped_res', [i14, MachineIntConstant(7)], Int(), '`14490', 'zz43040')
i16 = block3.emit(Operation, 'zz5i64zDzKz5i', [i4], Int(), '`14494', 'zz43035')
i17 = block3.emit(Operation, 'z__id', [i16], Int(), '`14496', 'zz43036')
i18 = block3.emit(Operation, 'zz5izDzKz5i64', [i17], MachineInt(), '`14497', 'zz43031')
i19 = block3.emit(Operation, '@sub_o_i_wrapped_res', [i15, i18], Int(), '`14503', 'zz43034')
i20 = block3.emit(Operation, '@add_o_i_wrapped_res', [i19, MachineIntConstant(1)], Int(), '`14510', 'zz43029')
i21 = block3.emit(Operation, 'zzzeros_implicit', [i20], GenericBitVector(), '`43 269:55-269:62', 'zz43023')
i22 = block3.emit(Operation, 'zeq_bits', [i12, i21], Bool(), '`43 269:30-269:62', 'zz43021')
...
i26 = block5.emit(Operation, '@vector_update_subrange_o_i_i_o', [i25, i8, i4, i24], GenericBitVector(), '`43 269:4-269:24', 'zz43020')
i27 = block5.emit(Cast, '$cast', [i26], SmallFixedBitVector(64), '`43 269:4-269:24', 'zz43007')
i3.prevvalues[1] = i27
i28 = block5.emit(Operation, '@iadd', [i4, MachineIntConstant(8)], MachineInt(), '`43 268:2-271:36', 'zz43013')
i4.prevvalues[1] = i28
...
def test_anticipated_cast():
    ...
    move_casts_early(graph, fakecodegen)
