...
i12 = block3.emit(Operation, '@tdiv_int_i_i', [i11, i6], MachineInt(), '`1 186:4-186:22', 'zz41')
...
i17 = block5.emit(Operation, '@tdiv_int_i_i', [i9, i6], MachineInt(), '`1 190:4-190:18', 'return')
...
def test_phi_node_dead_prevvalue():
    ...
    i3 = block3.emit_phi([block1, block2], [i2, MachineIntConstant(2)], types.MachineInt())
