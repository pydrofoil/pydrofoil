...
def get_main(outarm):
    ...
    def main(argv):
        ...
        outarm.func_z__SetConfig(machine, "cpu.cpu0.RVBAR", bitvector.Integer.fromint(0x80000000))
        outarm.func_z__SetConfig(machine, "cpu.has_tlb", bitvector.Integer.fromint(0x0))
