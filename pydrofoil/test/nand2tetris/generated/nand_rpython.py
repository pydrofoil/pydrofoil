...
class Struct_ztuplez3z5bool_z5bool_z5bool(supportcode.ObjectBase):
    ztuplez3z5bool_z5bool_z5bool0 = False
    ztuplez3z5bool_z5bool_z5bool1 = False
    ztuplez3z5bool_z5bool_z5bool2 = False
    ...
    def copy_into(self, res=None):
        ...
        res.ztuplez3z5bool_z5bool_z5bool0 = self.ztuplez3z5bool_z5bool_z5bool0
        res.ztuplez3z5bool_z5bool_z5bool1 = self.ztuplez3z5bool_z5bool_z5bool1
        res.ztuplez3z5bool_z5bool_z5bool2 = self.ztuplez3z5bool_z5bool_z5bool2
        return res
    @objectmodel.always_inline
    def eq(self, other):
...
class Struct_ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump(supportcode.ObjectBase):
    ...
    def copy_into(self, res=None):
        if res is None: res = type(self)()
        res.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump0 = self.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump0
        res.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump1 = self.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump1
        res.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump2 = self.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump2
        res.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump3 = self.ztuplez3z5bv1_z5enumz0zzarithmetic_op_z5structz0zztuplezz3zz5bool_zz5bool_zz5bool_z5enumz0zzjump3
        return res
    @objectmodel.always_inline
    def eq(self, other):
...
class Tuple_19(supportcode.ObjectBase): # TupleType(elements=[NamedType('%bv16'), EnumType(name='zjump')])
    ...
    def eq(self, other):
        ...
        return True
smallintconst0_1 = bitvector.int_fromint(0)
smallintconst1_1 = bitvector.int_fromint(1)
...
def func_zneq_int(machine, zx_0, zx_1, zy_0, zy_1):
    ...
    return_ = supportcode.not_(machine, supportcode.eq_int(machine, (zx_0, zx_1), (zy_0, zy_1)))
    # End()
    return return_
...
# FunctionType(argtype=TupleType(elements=[NamedType('%bv3')]), restype=StructType(name='ztuplez3z5bool_z5bool_z5bool'))
...
# FunctionType(argtype=TupleType(elements=[NamedType('%bv16')]), restype=UnionType(name='zoptionzIUinstrzIzKzK'))
                        ...
                        if not (Enum_zarithmetic_op.zC_D == zop):
                            ...
                            if not (Enum_zarithmetic_op.zC_A == zop):
                                ...
                                if not (Enum_zarithmetic_op.zC_NOT_D == zop):
                                        ...
                                        if not (Enum_zarithmetic_op.zC_NEG_D == zop):
                                            ...
                                            if not (Enum_zarithmetic_op.zC_NEG_A == zop):
                                                ...
                                                if not (Enum_zarithmetic_op.zC_D_ADD_1 == zop):
                                                        ...
                                                        if not (Enum_zarithmetic_op.zC_D_SUB_1 == zop):
                                                            ...
                                                            if not (Enum_zarithmetic_op.zC_A_SUB_1 == zop):
                                                                ...
                                                                if not (Enum_zarithmetic_op.zC_D_ADD_A == zop):
                                                                    ...
                                                                    if not (Enum_zarithmetic_op.zC_D_SUB_A == zop):
                                                                        ...
                                                                        if not (Enum_zarithmetic_op.zC_A_SUB_D == zop):
                                                                            ...
                                                                            if not (Enum_zarithmetic_op.zC_D_AND_A == zop):
                                                                                ...
                                                                                (zz45_1, zz45_2, zz45_3) = bitvector.from_ruint(16, zz40)
                                                                                ...
                                                                                zz43 = bitvector.bv_touint(supportcode.or_bits(machine, bitvector.from_ruint(16, zz41), (zz45_1, zz45_2, zz45_3)))
                                                                                pc = 144
                                                                                continue
                                                                            # zz48: NamedType('%bv')
                                                                            ...
                                                                            (zz48_1, zz48_2, zz48_3) = bitvector.from_ruint(16, zz40)
                                                                            ...
                                                                            zz43 = bitvector.bv_touint(supportcode.and_bits(machine, bitvector.from_ruint(16, zz41), (zz48_1, zz48_2, zz48_3)))
                                                                            pc = 144
                                                                            continue
                                                                        # zz410: NamedType('%bv')
                                                                        ...
                                                                        (zz410_1, zz410_2, zz410_3) = bitvector.from_ruint(16, zz40)
                                                                        ...
                                                                        zz43 = bitvector.bv_touint(supportcode.sub_bits(machine, (zz410_1, zz410_2, zz410_3), bitvector.from_ruint(16, zz41)))
                                                                        pc = 144
                                                                        continue
                                                                    # zz414: NamedType('%bv')
                                                                    ...
                                                                    (zz414_1, zz414_2, zz414_3) = bitvector.from_ruint(16, zz40)
                                                                    ...
                                                                    zz43 = bitvector.bv_touint(supportcode.sub_bits(machine, bitvector.from_ruint(16, zz41), (zz414_1, zz414_2, zz414_3)))
                                                                    pc = 144
                                                                    continue
                                                                # zz417: NamedType('%bv')
                                                                ...
                                                                (zz417_1, zz417_2, zz417_3) = bitvector.from_ruint(16, zz40)
                                                                ...
                                                                zz43 = bitvector.bv_touint(supportcode.add_bits(machine, bitvector.from_ruint(16, zz41), (zz417_1, zz417_2, zz417_3)))
                                                                pc = 144
                                                                continue
                                                            # zz419: NamedType('%bv')
                                                            ...
                                                            (zz419_1, zz419_2, zz419_3) = bitvector.from_ruint(16, zz40)
                                                            ...
                                                            zz43 = bitvector.bv_touint(supportcode.sub_bits(machine, (zz419_1, zz419_2, zz419_3), bitvectorconstant0x0001_1))
                                                            pc = 144
                                                            continue
                                                    ...
                                                    (zz425_1, zz425_2, zz425_3) = bitvector.from_ruint(16, zz40)
                                                    ...
                                                    zz43 = bitvector.bv_touint(supportcode.add_bits(machine, (zz425_1, zz425_2, zz425_3), bitvectorconstant0x0001_1))
                                                    pc = 144
                                                    continue
                                            ...
                                            (zz432_1, zz432_2, zz432_3) = bitvector.from_ruint(16, zz40)
                                            ...
                                            zz43 = bitvector.bv_touint(supportcode.sub_bits(machine, bitvectorconstant0x0000_1, (zz432_1, zz432_2, zz432_3)))
                                            pc = 144
                                            continue
                                    ...
                                    (zz437_1, zz437_2, zz437_3) = bitvector.from_ruint(16, zz40)
                                    ...
                                    zz43 = bitvector.bv_touint(supportcode.not_bits(machine, (zz437_1, zz437_2, zz437_3)))
                                    pc = 144
                                    continue
...
# FunctionType(argtype=TupleType(elements=[StructType(name='ztuplez3z5bool_z5bool_z5bool'), NamedType('%bv16')]), restype=NamedType('%unit'))
...
def func_zmaybe_jump(machine, zvalue, zj):
    ...
    while 1:
            ...
            if not (Enum_zjump.zJDONT == zj):
                ...
                if not (Enum_zjump.zJGT == zj):
                    ...
                    if not (Enum_zjump.zJEQ == zj):
                        ...
                        if not (Enum_zjump.zJGE == zj):
                            ...
                            if not (Enum_zjump.zJLT == zj):
                                ...
                                if not (Enum_zjump.zJNE == zj):
                                    ...
                                    zz44 = supportcode.lteq(machine, bitvector.int_fromint(supportcode.signed_bv(machine, zvalue, 16)), smallintconst0_1)
                                    pc = 87
                                    continue
                                ...
                                zz44 = supportcode.not_(machine, supportcode.eq_int_i_i(machine, supportcode.int_to_int64(machine, bitvector.int_fromint(supportcode.signed_bv(machine, zvalue, 16))), 0))
                                pc = 87
                                continue
                            ...
                            zz44 = supportcode.lt(machine, bitvector.int_fromint(supportcode.signed_bv(machine, zvalue, 16)), smallintconst0_1)
                            pc = 87
                            continue
                        ...
                        zz44 = supportcode.gteq(machine, bitvector.int_fromint(supportcode.signed_bv(machine, zvalue, 16)), smallintconst0_1)
                        pc = 87
                        continue
                    ...
                    zz44 = supportcode.eq_int_i_i(machine, supportcode.int_to_int64(machine, bitvector.int_fromint(supportcode.signed_bv(machine, zvalue, 16))), 0)
                    pc = 87
                    continue
                ...
                zz44 = supportcode.gt(machine, bitvector.int_fromint(supportcode.signed_bv(machine, zvalue, 16)), smallintconst0_1)
                pc = 87
                continue
        ...
        if pc == 87:
            ...
            (zz42_1, zz42_2, zz42_3) = bitvector.from_ruint(16, machine._reg_zPC)
            ...
            machine._reg_zPC = bitvector.bv_touint(supportcode.add_bits_int(machine, (zz42_1, zz42_2, zz42_3), smallintconst1_1))
    ...
    while 1:
        ...
        if pc == 16:
            ...
            if func_zfetch_decode_execute(machine, ()):
                ...
                (zz416_1, zz416_2, zz416_3) = bitvector.from_ruint(64, zz40)
                ...
                if supportcode.lt(machine, supportcode.sail_signed(machine, (zz416_1, zz416_2, zz416_3)), bitvector.int_fromint(supportcode.signed_bv(machine, zlimit, 64))):
                    # inline pc=43
        ...
        if pc == 45:
            ...
            (zz44_1, zz44_2, zz44_3) = bitvector.from_ruint(64, zz40)
            ...
            zz40 = bitvector.bv_touint(supportcode.add_bits(machine, (zz44_1, zz44_2, zz44_3), bitvectorconstant0x0000000000000001_1))
