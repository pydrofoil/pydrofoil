...
from pydrofoil.absinterp import Range, Location, LocationManager, compute_all_ranges
import pytest
...
def _get_example_struct_ranges():
    s = ir.Argument("s", types.Struct("S", ("x", "y"), (types.Int(), types.Int())))
    t = ir.Argument("t", types.Struct("T", ("x", "y"), (types.Int(), types.Int())))
    u = ir.Argument("u", types.Struct("U", ("x", "y"), (types.Int(), types.Int())))
    ...
    block_g.emit(ir.StructConstruction, "S", [ir.IntConstant(9), ir.IntConstant(100)], s.resolved_type)
...
def test_struct_ranges():
    ...
    s_loc = locmanager.get_location_for_field(types.Struct("S", ("x", "y"), (types.Int(), types.Int())), "y")
